...
begin
  ...
  FConnList.Items[Result].Params.Database :=  ExtractFileDir(ExtractFileDir(ExtractFileDir(ParamStr(0)))) + '\BANCO.FDB';
  FConnList.Items[Result].Params.UserName := 'caracteristicas';
  FConnList.Items[Result].Params.Password := 'impermeabilizar';
